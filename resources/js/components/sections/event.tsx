...
export default function Event() {
    return (
        <section className="flex h-full flex-col items-center justify-between bg-peach text-center text-navy">
            <Flower />
            <h2 className="w-sm text-center font-gelasio text-3xl">
                Sabtu, 4 Juli 2026
            </h2>
            ...
            <div>
                ...
                <div className="font-gelasio text-2xl">
            ...
            <div className="flex items-center justify-between gap-4">
                ...
                >
                    <button className="flex items-center justify-between gap-2 rounded-md bg-navy p-2 font-belleza text-sm tracking-wide text-peach hover:bg-navy/80">
                        <img
                            src="/svg/maps.svg"
                            alt="Google Maps"
                            className="size-5"
